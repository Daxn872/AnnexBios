        ...
        <div id="main-body">
            <div id="main-info">
                ...
                <div class="container-film">
                    <img src="../assets\img\films\Jurassic-World_-Fallen-Kingdom.jpg" alt="JurassicPark">
                    <div class="container-film-info">
                        <div class="film-info">
                            <div class="film-review">
                                <img src="../assets/img/icons/review.svg" alt="colored star">
                                <img src="../assets/img/icons/review.svg" alt="colored star">
                                <img src="../assets/img/icons/review.svg" alt="colored star">
                                <img src="../assets/img/icons/review.svg" alt="colored star">
                                <img class="uncolored-star" src="../assets/img/icons/review.svg" alt="uncolored star">
                            </div>
                            <div class="film-restrictions">
                                <img src="../assets/img/kijkwijzers/kijkwijzer-12.png" alt="kijkwijzer 12">
                                <img src="../assets/img/kijkwijzers/kijkwijzer-eng.png" alt="kijkwijzer eng">
                                <img src="../assets/img/kijkwijzers/kijkwijzer-geweld.png" alt="kijkwijzer geweld">
                            </div>
                                            ...
                                            <ul class="info-actors">
                                                <li>
                                                    <div class="container-actors">
                                                        <img src="../assets/img/acteurs/BryceDallas.jpg" alt="Bryce Dalas Howard">
                                                        <p>Bryce Dallas Howard</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="container-actors">
                                                        <img src="../assets/img/acteurs/Chris_Pratt.jpg" alt="Chriss Pratt">
                                                        <p>Chriss Pratt</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="container-actors">
                                                        <img src="../assets/img/acteurs/rafe_spall.jpg" alt="Rafe Spall">
                                                        <p>Rafe Spall</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="container-actors">
                                                        <img src="../assets/img/acteurs/Toby_Jones.jpg" alt="Toby Jones">
                                                        <p>Toby Jones</p>
                                                    </div>
                                                </li>
                                            </ul>
